        ...
        with open(local_data_path,'rb') as f:
            ...
            if show == True:
                for k,v in res_pic.items():
                    print(k)
                    print('\n第二层key',v.keys())
                    print('\n第三层key',v['data_randomforest_classify_grid'].keys())

                    print('\n第三层key',v['data_randomforest_classify_grid'].shape)
                    ...
                    v['data_randomforest_classify_grid']['new'] =v['data_randomforest_classify_grid']['canshu']+v['data_randomforest_classify_grid']['celue_name']
                    print('\n第三层key',v['data_randomforest_classify_grid'][v['data_randomforest_classify_grid']['预测周期真实分类']>= 7].sample(10))
                    exit()
...
if __name__ == '__main__':
    ...
    if 1 == True:
        ...
        # show_local_data(r'F:\new_0811\huice_log\MEBD03_pre_res\tx\贪心集中zuhe_911_02mebd01_训练结果10_09-16.pickle',show=True)
        # exit()
        # fenge_canshu()
