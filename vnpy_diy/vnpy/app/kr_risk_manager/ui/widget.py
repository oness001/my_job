...
class KRRiskManager(QtWidgets.QDialog):
    """"""
    ...
    def save_setting(self):
        ...
        setting = {
            ...
            "exposed_position_limit": self.position_limit_spin.value()
        }
    ...
    def update_setting(self):
        ...
        self.position_limit_spin.setValue(setting["exposed_position_limit"])
