...
from vnpy.trader.event import EVENT_TRADE, EVENT_ORDER, EVENT_LOG, EVENT_POSITION
...
class KRRiskManagerEngine(BaseEngine):
    """"""
    setting_filename = "kr_risk_manager_setting.json"
    ...
    def update_setting(self, setting: dict):
        ...
        self.exposed_position_limit = setting["exposed_position_limit"]
    ...
    def get_setting(self):
        ...
        setting = {
            ...
            "exposed_position_limit": self.exposed_position_limit
        }
        return setting
